return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", "[w", "<Plug>CamelCaseMotion_b", { silent = true })
    ...
    vim.api.nvim_set_keymap("x", "[w", "<Plug>CamelCaseMotion_b", { silent = true })
    ...
    vim.api.nvim_set_keymap("o", "[w", "<Plug>CamelCaseMotion_b", { silent = true })
